...
silent only
silent tabonly
cd ~/Documents/freelancergit/wsserver
...
let s:l = 121 - ((26 * winheight(0) + 18) / 37)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 33 - ((19 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
33
...
710
normal! zo
let s:l = 387 - ((117 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
387
